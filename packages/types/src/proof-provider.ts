...
export interface ProofProvider<K extends string> {
   ...
   */
  proveTx<S extends Signaturish, P extends Proofish, B extends Bindingish>(tx: Transaction<S, P, B>, proveTxConfig?: ProveTxConfig<K>): Promise<UnbalancedTransaction>;
}
