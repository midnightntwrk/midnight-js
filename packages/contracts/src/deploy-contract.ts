 ...
 */
export type DeployContractOptionsBase<C extends Contract> =
  ContractConstructorOptionsWithArguments<C> & {
    /**
 ...
 */
export type DeployContractOptionsWithPrivateState<C extends Contract> =
