...
import type { FinalizedTxData, Contract, ImpureCircuitId, PrivateState } from '@midnight-ntwrk/midnight-js-types';
import type { ShieldedCoinInfo, Transaction } from '@midnight-ntwrk/ledger';
