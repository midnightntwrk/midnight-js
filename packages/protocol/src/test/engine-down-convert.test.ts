...
describe('extractEncodedStateValue', () => {
  ...
  // reachable from any untyped JS caller. They must throw a coded error
  // instead, and the unvalidated string must never reach the error's `stage`.
  it.each(['constructor', 'toString', 'valueOf', 'isPrototypeOf', '__proto__', 'bogus'])(
