...
export class CounterConfiguration implements ContractConfiguration {
  ...
  constructor(privateStateStoreName?: string, zkConfigPath?: string) {
    ...
    this.zkConfigPath =
      zkConfigPath || path.resolve(currentDir, '..', 'dist', 'contract', 'managed', 'counter');
  }
}
...
export class CounterCloneConfiguration implements ContractConfiguration {
  ...
  constructor(privateStateStoreName?: string, zkConfigPath?: string) {
    ...
    this.zkConfigPath =
      zkConfigPath ||
      path.resolve(currentDir, '..', 'dist', 'contract', 'managed', 'counter-clone');
  }
}
...
export class SimpleConfiguration implements ContractConfiguration {
  ...
  constructor(privateStateStoreName?: string, zkConfigPath?: string) {
    ...
    this.zkConfigPath =
      zkConfigPath || path.resolve(currentDir, '..', 'dist', 'contract', 'managed', 'simple');
  }
}
...
export const randomCircuitId = (length: number = 32) =>
  Array.from({ length }, () =>
...
export const deployCounterContract = async (
  ...
  const deployedCounterContract: DeployedCounterContract = await deploy(
    counterProviders,
    privateState
  );
