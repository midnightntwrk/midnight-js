...
export type HeadProtocolVersionQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type HeadProtocolVersionQueryQuery = { readonly block: { readonly protocolVersion: number } | null };
...
export type DeployContractStateTxQueryQuery = { readonly contractAction:
    | { readonly deploy: { readonly transaction:
          | { readonly protocolVersion: number, readonly contractActions: ReadonlyArray<
    ...
    | { readonly state: string, readonly transaction:
...
export type TxsFromBlockSubSubscription = { readonly blocks: { readonly hash: string, readonly height: number, readonly protocolVersion: number, readonly transactions: ReadonlyArray<
...
export type ContractStateQueryQuery = { readonly block: { readonly protocolVersion: number } | null, readonly contract: { readonly state: string } | null };

export type RawContractStateQueryQueryVariables = Exact<{
  address: string;
  offset: BlockOffset | null | undefined;
}>;


export type RawContractStateQueryQuery = { readonly block: { readonly protocolVersion: number, readonly ledgerParameters: string } | null, readonly contract: { readonly state: string } | null };
...
export type ContractAndZswapStateQueryQuery = { readonly block: { readonly protocolVersion: number, readonly ledgerParameters: string, readonly contractZswapState: string | null } | null, readonly contract: { readonly state: string } | null };
...
export type ContractEventsQueryQuery = { readonly contractEvents: ReadonlyArray<
    | { readonly __typename: 'MiscContractEvent', readonly name: string, readonly payload: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string }
    | { readonly __typename: 'PausedEvent', readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string }
    | { readonly __typename: 'ShieldedBurnEvent', readonly nullifier: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string, readonly shieldedAmount: string | null }
    | { readonly __typename: 'ShieldedMintEvent', readonly commitment: string, readonly domainSep: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string, readonly shieldedAmount: string | null }
    | { readonly __typename: 'ShieldedReceiveEvent', readonly commitment: string, readonly ciphertext: string | null, readonly receivingContractAddress: string | null, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string }
    | { readonly __typename: 'ShieldedSpendEvent', readonly nullifier: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string }
    | { readonly __typename: 'UnpausedEvent', readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string }
    | { readonly __typename: 'UnshieldedBurnEvent', readonly tokenType: string, readonly amount: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string, readonly sender: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } }
    | { readonly __typename: 'UnshieldedMintEvent', readonly domainSep: string, readonly tokenType: string, readonly amount: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string }
    | { readonly __typename: 'UnshieldedReceiveEvent', readonly domainSep: string, readonly tokenType: string, readonly amount: string, readonly id: number, readonly maxId: number, readonly version: number, readonly protocolVersion: number, readonly contractAddress: string, readonly transactionId: number, readonly raw: string, readonly recipient: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } }
...
export const HeadProtocolVersionQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"HEAD_PROTOCOL_VERSION_QUERY"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"block"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"protocolVersion"}}]}}]}}]} as unknown as DocumentNode<HeadProtocolVersionQueryQuery, HeadProtocolVersionQueryQueryVariables>;
...
export const RawContractStateQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"RAW_CONTRACT_STATE_QUERY"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"address"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"HexEncoded"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"offset"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BlockOffset"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"block"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"offset"},"value":{"kind":"Variable","name":{"kind":"Name","value":"offset"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"protocolVersion"}},{"kind":"Field","name":{"kind":"Name","value":"ledgerParameters"}}]}},{"kind":"Field","name":{"kind":"Name","value":"contract"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"address"},"value":{"kind":"Variable","name":{"kind":"Name","value":"address"}}},{"kind":"Argument","name":{"kind":"Name","value":"offset"},"value":{"kind":"Variable","name":{"kind":"Name","value":"offset"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"state"}}]}}]}}]} as unknown as DocumentNode<RawContractStateQueryQuery, RawContractStateQueryQueryVariables>;
