...
export type ContractEventsQueryQuery = { readonly contractEvents: ReadonlyArray<
    | { readonly __typename: 'MiscContractEvent', readonly name: string, readonly payload: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'PausedEvent', readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'ShieldedBurnEvent', readonly nullifier: string, readonly amount: string | null, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'ShieldedMintEvent', readonly commitment: string, readonly domainSep: string, readonly amount: string | null, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'ShieldedReceiveEvent', readonly commitment: string, readonly ciphertext: string | null, readonly receivingContractAddress: string | null, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'ShieldedSpendEvent', readonly nullifier: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'UnpausedEvent', readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number }
    | { readonly __typename: 'UnshieldedBurnEvent', readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string, readonly sender: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } }
    | { readonly __typename: 'UnshieldedMintEvent', readonly domainSep: string, readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string }
    | { readonly __typename: 'UnshieldedReceiveEvent', readonly domainSep: string, readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string, readonly recipient: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } }
