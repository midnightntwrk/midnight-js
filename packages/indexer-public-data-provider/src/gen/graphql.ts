...
export type TxIdQueryQuery = { transactions: Array<{ raw: string, hash: string, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null } }> };
...
export type DeployTxQueryQuery = { contractAction: { deploy: { transaction: { raw: string, hash: string, identifiers: Array<string>, contractActions: Array<{ address: string } | { address: string } | { address: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null } } } } | { transaction: { raw: string, hash: string, identifiers: Array<string>, contractActions: Array<{ address: string } | { address: string } | { address: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null } } } | { transaction: { raw: string, hash: string, identifiers: Array<string>, contractActions: Array<{ address: string } | { address: string } | { address: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null } } } | null };
