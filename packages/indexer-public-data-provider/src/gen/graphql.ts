...
type ContractEventFieldsMiscContractEventFragment = { readonly __typename: 'MiscContractEvent', readonly name: string, readonly payload: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsMiscContractEventFragment' };

type ContractEventFieldsPausedEventFragment = { readonly __typename: 'PausedEvent', readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsPausedEventFragment' };

type ContractEventFieldsShieldedBurnEventFragment = { readonly __typename: 'ShieldedBurnEvent', readonly nullifier: string, readonly amount: string | null, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsShieldedBurnEventFragment' };

type ContractEventFieldsShieldedMintEventFragment = { readonly __typename: 'ShieldedMintEvent', readonly commitment: string, readonly domainSep: string, readonly amount: string | null, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsShieldedMintEventFragment' };

type ContractEventFieldsShieldedReceiveEventFragment = { readonly __typename: 'ShieldedReceiveEvent', readonly commitment: string, readonly ciphertext: string | null, readonly receivingContractAddress: string | null, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsShieldedReceiveEventFragment' };

type ContractEventFieldsShieldedSpendEventFragment = { readonly __typename: 'ShieldedSpendEvent', readonly nullifier: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsShieldedSpendEventFragment' };

type ContractEventFieldsUnpausedEventFragment = { readonly __typename: 'UnpausedEvent', readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number } & { ' $fragmentName'?: 'ContractEventFieldsUnpausedEventFragment' };

type ContractEventFieldsUnshieldedBurnEventFragment = { readonly __typename: 'UnshieldedBurnEvent', readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string, readonly sender: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } } & { ' $fragmentName'?: 'ContractEventFieldsUnshieldedBurnEventFragment' };

type ContractEventFieldsUnshieldedMintEventFragment = { readonly __typename: 'UnshieldedMintEvent', readonly domainSep: string, readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string } & { ' $fragmentName'?: 'ContractEventFieldsUnshieldedMintEventFragment' };

type ContractEventFieldsUnshieldedReceiveEventFragment = { readonly __typename: 'UnshieldedReceiveEvent', readonly domainSep: string, readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string, readonly recipient: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } } & { ' $fragmentName'?: 'ContractEventFieldsUnshieldedReceiveEventFragment' };

type ContractEventFieldsUnshieldedSpendEventFragment = { readonly __typename: 'UnshieldedSpendEvent', readonly domainSep: string, readonly tokenType: string, readonly id: number, readonly raw: string, readonly maxId: number, readonly protocolVersion: number, readonly version: number, readonly contractAddress: string, readonly transactionId: number, readonly amountRequired: string, readonly sender: { readonly kind: AddressOrContractKind, readonly userAddress: string | null, readonly contractAddress: string | null } } & { ' $fragmentName'?: 'ContractEventFieldsUnshieldedSpendEventFragment' };

export type ContractEventFieldsFragment =
  | ContractEventFieldsMiscContractEventFragment
  | ContractEventFieldsPausedEventFragment
  | ContractEventFieldsShieldedBurnEventFragment
  | ContractEventFieldsShieldedMintEventFragment
  | ContractEventFieldsShieldedReceiveEventFragment
  | ContractEventFieldsShieldedSpendEventFragment
  | ContractEventFieldsUnpausedEventFragment
  | ContractEventFieldsUnshieldedBurnEventFragment
  | ContractEventFieldsUnshieldedMintEventFragment
  | ContractEventFieldsUnshieldedReceiveEventFragment
  | ContractEventFieldsUnshieldedSpendEventFragment
;
...
export type ContractEventsQueryQuery = { readonly contractEvents: ReadonlyArray<
    | { ' $fragmentRefs'?: { 'ContractEventFieldsMiscContractEventFragment': ContractEventFieldsMiscContractEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsPausedEventFragment': ContractEventFieldsPausedEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsShieldedBurnEventFragment': ContractEventFieldsShieldedBurnEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsShieldedMintEventFragment': ContractEventFieldsShieldedMintEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsShieldedReceiveEventFragment': ContractEventFieldsShieldedReceiveEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsShieldedSpendEventFragment': ContractEventFieldsShieldedSpendEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsUnpausedEventFragment': ContractEventFieldsUnpausedEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsUnshieldedBurnEventFragment': ContractEventFieldsUnshieldedBurnEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsUnshieldedMintEventFragment': ContractEventFieldsUnshieldedMintEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsUnshieldedReceiveEventFragment': ContractEventFieldsUnshieldedReceiveEventFragment } }
    | { ' $fragmentRefs'?: { 'ContractEventFieldsUnshieldedSpendEventFragment': ContractEventFieldsUnshieldedSpendEventFragment } }
  > };
