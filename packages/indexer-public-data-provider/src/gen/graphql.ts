...
export type TxIdQueryQuery = { transactions: Array<{ raw: string, hash: string, unshieldedCreatedOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }>, unshieldedSpentOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null } }> };
...
export type DeployTxQueryQuery = { contractAction: { deploy: { transaction: { raw: string, hash: string, identifiers: Array<string>, contractActions: Array<{ address: string } | { address: string } | { address: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null }, unshieldedCreatedOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }>, unshieldedSpentOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }> } } } | { transaction: { raw: string, hash: string, identifiers: Array<string>, contractActions: Array<{ address: string } | { address: string } | { address: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null }, unshieldedCreatedOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }>, unshieldedSpentOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }> } } | { transaction: { raw: string, hash: string, identifiers: Array<string>, contractActions: Array<{ address: string } | { address: string } | { address: string }>, block: { height: number, hash: string }, transactionResult: { status: TransactionResultStatus, segments: Array<{ id: number, success: boolean }> | null }, unshieldedCreatedOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }>, unshieldedSpentOutputs: Array<{ owner: string, intentHash: string, tokenType: string, value: string }> } } | null };
