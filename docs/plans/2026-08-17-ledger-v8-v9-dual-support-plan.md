...
**Spec:** `docs/superpowers/specs/2026-07-09-ledger-v8-v9-dual-support-design.md` (v5.1).
...
**OQ-gated:** Plan-1 Tasks 1.7/1.8 and Plan-3 Task 3.2 wait on OQ13 (Plan-1 Task 0.1 — the blocking discovery). Everything else can start immediately in the plan order above.
...
## Self-review record (ran against spec v5.1)
