...
**Spec:** `docs/specs/2026-07-09-ledger-v8-v9-dual-support-design.md` (**v5.5**) — §4.1(5) (the era facade — read this first), §4.3 (the three real arm asymmetries + the partition-context rule), §4.5/OQ21, §6.2, §8 (contracts slice), OQ20/OQ21/OQ22. **OQ19 is closed — do not plan around a Zswap refusal.**
