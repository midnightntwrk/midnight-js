...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / EraDispatch
...
documented and could not close; see [OverloadTyping](OverloadTyping.md) for
