...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / Breadcrumbs
...
themselves are is [EraDispatch](EraDispatch.md).
...
see [VerificationPath](VerificationPath.md).
...
when that inference was replaced (see [EraDispatch](EraDispatch.md)), the
