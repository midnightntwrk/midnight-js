...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / StaleHeadRemediation
...
the first place is [EraDispatch](EraDispatch.md).
...
[KeepStatePipeline](KeepStatePipeline.md) for what that redaction removes.
