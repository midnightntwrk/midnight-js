...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / OverloadTyping
...
one — see [EraDispatch](EraDispatch.md) for which answer each era carries, why
