...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / [](../README.md) / LEDGER\_VERSIONS
...
## See
 ...
 - SharedTableDiscipline for why the array is frozen.
 - ModuleGraphAndLazyLoading for why the constant is declared in
