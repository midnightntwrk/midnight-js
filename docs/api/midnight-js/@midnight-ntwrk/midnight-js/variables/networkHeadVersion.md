...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / [](../README.md) / networkHeadVersion

# Variable: networkHeadVersion

> `const` **networkHeadVersion**: (`source`) => `Promise`\<[`LedgerVersion`](../type-aliases/LedgerVersion.md)\>
...
`Promise`\<[`LedgerVersion`](../type-aliases/LedgerVersion.md)\>
...
path, on the same two conditions as protocolVersionToLedger. A
