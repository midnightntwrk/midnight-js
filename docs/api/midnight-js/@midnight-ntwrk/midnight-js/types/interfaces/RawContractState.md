...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js](../../README.md) / [types](../README.md) / RawContractState
...
VersionTaggedPayloads for why the state crosses as bytes, and for
...
VersionTaggedPayloads for why they travel with the state rather than separately.
