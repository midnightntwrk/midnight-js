...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js](../../README.md) / [utils](../README.md) / ledgerParametersEnvelopeVersion

# Variable: ledgerParametersEnvelopeVersion

> `const` **ledgerParametersEnvelopeVersion**: (`raw`) => [`LedgerVersion`](../../type-aliases/LedgerVersion.md)
