...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js](../../README.md) / [utils](../README.md) / parseSerializedTag

# Variable: parseSerializedTag

> `const` **parseSerializedTag**: (`bytes`) => [`ParsedSerializedTag`](../interfaces/ParsedSerializedTag.md)
