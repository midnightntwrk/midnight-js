...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js](../README.md) / [](../README.md) / ComposeFailedError
...
Ledger8InstanceMismatchError. The exceptions are the stages where
...
DownConvertFailedError preserves its runtime's own message.
