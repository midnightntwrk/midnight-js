...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js](../../README.md) / [contracts](../README.md) / EraSeam

# Type Alias: EraSeam

> **EraSeam** = [`Seam`](../../types/type-aliases/Seam.md)
...
An alias for [Seam](../../types/type-aliases/Seam.md) in `@midnight-ntwrk/midnight-js-types`, which owns
