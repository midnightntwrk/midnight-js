...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js](../../README.md) / [contracts](../README.md) / EraInvariantViolationError
...
[`Seam`](../../types/type-aliases/Seam.md)
...
> `readonly` **seam**: [`Seam`](../../types/type-aliases/Seam.md)
