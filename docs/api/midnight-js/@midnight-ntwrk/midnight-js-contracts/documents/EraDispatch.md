...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js-contracts](../README.md) / EraDispatch
...
[VerificationPath](../../midnight-js/documents/VerificationPath.md).
...
documented and could not close; see [OverloadTyping](../../midnight-js/documents/OverloadTyping.md) for
