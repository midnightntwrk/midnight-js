...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js-contracts](../README.md) / KeepStatePipeline
...
[EraDispatch](../../midnight-js/documents/EraDispatch.md). The verifier-key check it performs is
