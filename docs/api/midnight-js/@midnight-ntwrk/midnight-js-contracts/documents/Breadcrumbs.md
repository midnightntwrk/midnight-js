...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js-contracts](../README.md) / Breadcrumbs
...
themselves are is [EraDispatch](../../midnight-js/documents/EraDispatch.md).
...
see [VerificationPath](../../midnight-js/documents/VerificationPath.md).
...
[StaleHeadRemediation](../../midnight-js/documents/StaleHeadRemediation.md).
...
when that inference was replaced (see [EraDispatch](../../midnight-js/documents/EraDispatch.md)), the
