...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js-contracts](../../README.md) / [index](../README.md) / isLedger8Result

# Function: isLedger8Result()

> **isLedger8Result**\<`T`\>(`result`): `result is NarrowedToRetained<T>`
