...
[Midnight.js API Reference](../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-contracts](../../../../README.md) / [index](../../../README.md) / [Ledger8](../README.md) / ContractProviders

# Type Alias: ContractProviders\<C, K\>

> **ContractProviders**\<`C`, `K`\> = [`MidnightProviders`](../../../../../midnight-js/types/interfaces/MidnightProviders.md)\<`K`, [`PrivateStateId`](../../../../../midnight-js/types/type-aliases/PrivateStateId.md), [`PrivateState`](PrivateState.md)\<`C`\>\>
