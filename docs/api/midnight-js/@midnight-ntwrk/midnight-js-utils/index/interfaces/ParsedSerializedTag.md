...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js-utils](../../README.md) / [index](../README.md) / ParsedSerializedTag

# Interface: ParsedSerializedTag

Result of [parseSerializedTag](../functions/parseSerializedTag.md). `namespace` and `version` are the two
