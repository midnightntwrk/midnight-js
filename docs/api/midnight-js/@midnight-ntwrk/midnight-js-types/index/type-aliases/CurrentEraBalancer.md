...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js-types](../../README.md) / [index](../README.md) / CurrentEraBalancer

# Type Alias: CurrentEraBalancer

> **CurrentEraBalancer** = (`tx`, `ttl?`) => `Promise`\<[`FinalizedTransaction`](https://github.com/midnightntwrk/midnight-ledger)\>
