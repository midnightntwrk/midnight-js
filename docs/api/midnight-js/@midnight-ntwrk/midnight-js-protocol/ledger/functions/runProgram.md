...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../README.md) / [ledger](../README.md) / runProgram

# Function: runProgram()

> **runProgram**(`initial`, `ops`, `cost_model`, `gas_limit?`): [`VmResults`](../classes/VmResults.md)

Defined in: node\_modules/@midnightntwrk/ledger-v9/ledger-v9.d.ts:738
