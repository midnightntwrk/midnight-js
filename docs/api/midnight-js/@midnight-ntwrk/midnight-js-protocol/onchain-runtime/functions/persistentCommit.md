...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../README.md) / [onchain-runtime](../README.md) / persistentCommit

# Function: persistentCommit()

> **persistentCommit**(`align`, `val`, `opening`): [`Value`](../type-aliases/Value.md)

Defined in: node\_modules/@midnightntwrk/onchain-runtime-v4/onchain-runtime-v4.d.ts:689
