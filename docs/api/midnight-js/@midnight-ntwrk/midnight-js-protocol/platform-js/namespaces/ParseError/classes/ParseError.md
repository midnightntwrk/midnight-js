...
[Midnight.js API Reference](../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../../../README.md) / [platform-js](../../../README.md) / [ParseError](../README.md) / ParseError

# Class: ParseError

Defined in: node\_modules/@midnight-ntwrk/platform-js/dist/dts/effect/ParseError.d.ts:12

Error indicating a failure to parse some string value.

## Extends

- `ParseError_base`\<\{ `cause?`: `unknown`; `message`: `string`; `meta?`: `Inspectable`; `source`: `string`; \}\>
...
Defined in: node\_modules/@midnight-ntwrk/platform-js/dist/dts/effect/ParseError.d.ts:4
...
`ParseError_base<{ /** A displayable message. */ readonly message: string; /** The source string that failed to parse. */ readonly source: string; /** Inspectable data about the parse operation. */ readonly meta?: Inspectable; /** The underlying cause of the failed parse operation. */ readonly cause?: unknown; }>.constructor`
...
Defined in: node\_modules/@midnight-ntwrk/platform-js/dist/dts/effect/ParseError.d.ts:5
...
> `readonly` `optional` **meta?**: `Inspectable`

Defined in: node\_modules/@midnight-ntwrk/platform-js/dist/dts/effect/ParseError.d.ts:18

Inspectable data about the parse operation.

#### Inherited from

`ParseError_base.meta`
...
Defined in: node\_modules/@midnight-ntwrk/platform-js/dist/dts/effect/ParseError.d.ts:16

The source string that failed to parse.

#### Inherited from

`ParseError_base.source`
