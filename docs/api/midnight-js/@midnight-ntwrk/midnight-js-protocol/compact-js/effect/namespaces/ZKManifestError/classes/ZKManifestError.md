...
[Midnight.js API Reference](../../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../../../../README.md) / [compact-js/effect](../../../README.md) / [ZKManifestError](../README.md) / ZKManifestError

# Class: ZKManifestError

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKManifestError.d.ts:11

An error that occurred while parsing a ZK artifact manifest.

## Extends

- `ZKManifestError_base`\<\{ `cause?`: `unknown`; `message`: `string`; \}\>

## Constructors

### Constructor

> **new ZKManifestError**(`args`): `ZKManifestError`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKManifestError.d.ts:3
...
`ZKManifestError_base<{ /** A displayable message. */ readonly message: string; /** Indicates a more specific cause of the error. */ readonly cause?: unknown; }>.constructor`

## Properties

### \_tag

> `readonly` **\_tag**: `"ZKManifestError"`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKManifestError.d.ts:4

#### Inherited from

`ZKManifestError_base._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `ZKManifestError`, `unknown`, `never`, `unknown`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:285

#### Inherited from

`ZKManifestError_base.[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `ZKManifestError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:282

#### Inherited from

`ZKManifestError_base.[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `ZKManifestError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:284

#### Inherited from

`ZKManifestError_base.[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `ZKManifestError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:283

#### Inherited from

`ZKManifestError_base.[StreamTypeId]`
...
`ZKManifestError_base.stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `ZKManifestError`, `never`\>\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `ZKManifestError`, `never`\>\>

#### Inherited from

`ZKManifestError_base.[iterator]`
...
`ZKManifestError_base.[NodeInspectSymbol]`
