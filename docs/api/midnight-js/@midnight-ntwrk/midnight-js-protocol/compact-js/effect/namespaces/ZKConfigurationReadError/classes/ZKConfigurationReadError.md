...
[Midnight.js API Reference](../../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../../../../README.md) / [compact-js/effect](../../../README.md) / [ZKConfigurationReadError](../README.md) / ZKConfigurationReadError

# Class: ZKConfigurationReadError

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKConfigurationReadError.d.ts:16

Error indicating a failure to read a ZK asset.

## Extends

- `ZKConfigurationReadError_base`\<\{ `assetType`: [`AssetType`](../type-aliases/AssetType.md); `cause?`: `unknown`; `contractTag`: `string`; `message`: `string`; `provableCircuitId`: [`ProvableCircuitId`](../../../../type-aliases/ProvableCircuitId.md); \}\>

## Constructors

### Constructor

> **new ZKConfigurationReadError**(`args`): `ZKConfigurationReadError`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKConfigurationReadError.d.ts:8
...
[`ProvableCircuitId`](../../../../type-aliases/ProvableCircuitId.md)
...
`ZKConfigurationReadError_base<{ /** A displayable message. */ readonly message: string; /** The underlying cause of the failed read operation. */ readonly cause?: unknown; /** The tag of the compiled contract being read. */ readonly contractTag: string; /** The circuit of the compiled contract being read. */ readonly provableCircuitId: Contract.ProvableCircuitId; /** The type of asset that was being read. */ readonly assetType: AssetType; }>.constructor`
...
Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKConfigurationReadError.d.ts:9

#### Inherited from

`ZKConfigurationReadError_base._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `ZKConfigurationReadError`, `unknown`, `never`, `unknown`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:285

#### Inherited from

`ZKConfigurationReadError_base.[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `ZKConfigurationReadError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:282

#### Inherited from

`ZKConfigurationReadError_base.[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `ZKConfigurationReadError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:284

#### Inherited from

`ZKConfigurationReadError_base.[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `ZKConfigurationReadError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:283

#### Inherited from

`ZKConfigurationReadError_base.[StreamTypeId]`
...
`ZKConfigurationReadError_base.[TypeId]`

***

### assetType

> `readonly` **assetType**: [`AssetType`](../type-aliases/AssetType.md)

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKConfigurationReadError.d.ts:26

The type of asset that was being read.

#### Inherited from

`ZKConfigurationReadError_base.assetType`
...
Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKConfigurationReadError.d.ts:22

The tag of the compiled contract being read.

#### Inherited from

`ZKConfigurationReadError_base.contractTag`
...
`ZKConfigurationReadError_base.name`

***

### provableCircuitId

> `readonly` **provableCircuitId**: [`ProvableCircuitId`](../../../../type-aliases/ProvableCircuitId.md)

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ZKConfigurationReadError.d.ts:24

The circuit of the compiled contract being read.

#### Inherited from

`ZKConfigurationReadError_base.provableCircuitId`
...
`ZKConfigurationReadError_base.stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `ZKConfigurationReadError`, `never`\>\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `ZKConfigurationReadError`, `never`\>\>

#### Inherited from

`ZKConfigurationReadError_base.[iterator]`
...
`ZKConfigurationReadError_base.[NodeInspectSymbol]`
...
`ZKConfigurationReadError_base.pipe`
...
`ZKConfigurationReadError_base.toJSON`
...
`ZKConfigurationReadError_base.toString`
