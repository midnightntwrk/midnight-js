...
[Midnight.js API Reference](../../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../../../../README.md) / [compact-js/effect](../../../README.md) / [MalformedHexPrefixError](../README.md) / MalformedHexPrefixError

# Class: MalformedHexPrefixError

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/MalformedHexPrefixError.d.ts:14
...
- `MalformedHexPrefixError_base`\<\{ `message`: `string`; `prefix`: `string`; \}\>

## Constructors

### Constructor

> **new MalformedHexPrefixError**(`args`): `MalformedHexPrefixError`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/MalformedHexPrefixError.d.ts:3
...
`MalformedHexPrefixError`

#### Inherited from

`` MalformedHexPrefixError_base<{ /** A displayable message. */ readonly message: string; /** The offending prefix, normalized (lowercased, any leading `0x` stripped). */ readonly prefix: string; }>.constructor ``

## Properties

### \_tag

> `readonly` **\_tag**: `"MalformedHexPrefixError"`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/MalformedHexPrefixError.d.ts:4

#### Inherited from

`MalformedHexPrefixError_base._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `MalformedHexPrefixError`, `unknown`, `never`, `unknown`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:285

#### Inherited from

`MalformedHexPrefixError_base.[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `MalformedHexPrefixError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:282

#### Inherited from

`MalformedHexPrefixError_base.[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `MalformedHexPrefixError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:284

#### Inherited from

`MalformedHexPrefixError_base.[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `MalformedHexPrefixError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:283

#### Inherited from

`MalformedHexPrefixError_base.[StreamTypeId]`
...
`MalformedHexPrefixError_base.[TypeId]`
...
`MalformedHexPrefixError_base.cause`
...
`MalformedHexPrefixError_base.name`
...
Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/MalformedHexPrefixError.d.ts:18

The offending prefix, normalized (lowercased, any leading `0x` stripped).

#### Inherited from

`MalformedHexPrefixError_base.prefix`
...
`MalformedHexPrefixError_base.stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `MalformedHexPrefixError`, `never`\>\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `MalformedHexPrefixError`, `never`\>\>

#### Inherited from

`MalformedHexPrefixError_base.[iterator]`
...
`MalformedHexPrefixError_base.[NodeInspectSymbol]`
...
`MalformedHexPrefixError_base.pipe`
...
`MalformedHexPrefixError_base.toJSON`
...
`MalformedHexPrefixError_base.toString`
