...
[Midnight.js API Reference](../../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../../../../README.md) / [compact-js/effect](../../../README.md) / [ContractEventValidationError](../README.md) / ContractEventValidationError

# Class: ContractEventValidationError

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ContractEventValidationError.d.ts:11

An error that occurred while validating that contract events comply with system constraints.

## Extends

- `ContractEventValidationError_base`\<\{ `cause?`: `unknown`; `message`: `string`; \}\>

## Constructors

### Constructor

> **new ContractEventValidationError**(`args`): `ContractEventValidationError`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ContractEventValidationError.d.ts:3
...
`ContractEventValidationError_base<{ /** A displayable message. */ readonly message: string; /** Indicates a more specific cause of the error. */ readonly cause?: unknown; }>.constructor`

## Properties

### \_tag

> `readonly` **\_tag**: `"ContractEventValidationError"`

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ContractEventValidationError.d.ts:4

#### Inherited from

`ContractEventValidationError_base._tag`

***

### \[ChannelTypeId\]

> `readonly` **\[ChannelTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `ContractEventValidationError`, `unknown`, `never`, `unknown`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:285

#### Inherited from

`ContractEventValidationError_base.[ChannelTypeId]`

***

### \[EffectTypeId\]

> `readonly` **\[EffectTypeId\]**: `VarianceStruct`\<`never`, `ContractEventValidationError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:282

#### Inherited from

`ContractEventValidationError_base.[EffectTypeId]`

***

### \[SinkTypeId\]

> `readonly` **\[SinkTypeId\]**: `VarianceStruct`\<`never`, `unknown`, `never`, `ContractEventValidationError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:284

#### Inherited from

`ContractEventValidationError_base.[SinkTypeId]`

***

### \[StreamTypeId\]

> `readonly` **\[StreamTypeId\]**: `VarianceStruct`\<`never`, `ContractEventValidationError`, `never`\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:283

#### Inherited from

`ContractEventValidationError_base.[StreamTypeId]`
...
`ContractEventValidationError_base.[TypeId]`
...
`ContractEventValidationError_base.name`
...
`ContractEventValidationError_base.stack`

## Methods

### \[iterator\]()

> **\[iterator\]**(): `EffectGenerator`\<`Effect`\<`never`, `ContractEventValidationError`, `never`\>\>

Defined in: node\_modules/effect/dist/dts/Cause.d.ts:286

#### Returns

`EffectGenerator`\<`Effect`\<`never`, `ContractEventValidationError`, `never`\>\>

#### Inherited from

`ContractEventValidationError_base.[iterator]`
...
`ContractEventValidationError_base.[NodeInspectSymbol]`
...
`ContractEventValidationError_base.pipe`
...
`ContractEventValidationError_base.toJSON`
...
`ContractEventValidationError_base.toString`
