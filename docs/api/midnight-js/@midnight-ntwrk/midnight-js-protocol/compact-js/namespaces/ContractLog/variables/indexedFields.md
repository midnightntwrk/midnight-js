...
[Midnight.js API Reference](../../../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../../../README.md) / [compact-js](../../../README.md) / [ContractLog](../README.md) / indexedFields

# Variable: indexedFields

> `const` **indexedFields**: (`event`) => `Record`\<`string`, `Uint8Array`\>

Defined in: node\_modules/@midnight-ntwrk/compact-js/dist/dts/effect/ContractLog.d.ts:226
