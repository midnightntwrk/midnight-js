...
[Midnight.js API Reference](../../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../../README.md) / [index](../README.md) / StateDecodeFailedError
...
> `readonly` **code**: `"MIDNIGHT_JS_P_STATE_DECODE_FAILED"` = `PROTOCOL_ERROR_CODES.STATE_DECODE_FAILED`
