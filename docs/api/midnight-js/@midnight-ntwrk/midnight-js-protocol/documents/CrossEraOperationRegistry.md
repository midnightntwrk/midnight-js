...
[Midnight.js API Reference](../../../packages.md) / [@midnight-ntwrk/midnight-js-protocol](../README.md) / CrossEraOperationRegistry
...
The composition this feeds is [ComposeRefusalOrder](ComposeRefusalOrder.md);
