...
> **CircuitMaintenanceTxInterfaces**\<`C`\> = `Record`\<[`ImpureCircuitId`](../../midnight-js-types/type-aliases/ImpureCircuitId.md)\<`C`\>, [`CircuitMaintenanceTxInterface`](CircuitMaintenanceTxInterface.md)\>
