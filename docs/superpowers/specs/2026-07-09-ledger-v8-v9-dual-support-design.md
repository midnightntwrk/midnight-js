...
**Status:** Draft v3.8 (naming ruling)
**Date:** 2026-07-09 (v1) · 2026-08-03 (v2 — keep-state rework) · 2026-08-04 (v3 — simplification rework; v3.1 — TS-dev review findings) · 2026-08-05 (v3.2 — upstream answers, #1005; v3.3 — architecture re-review; v3.4 — senior-dev re-review) · 2026-08-06 (v3.5 — per-major version mapping; v3.6 — helpers to `utils`; v3.7 — QA review; v3.8 — version-neutral helper names)
