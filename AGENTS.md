...
This project is indexed by GitNexus as **midnight-js** (5561 symbols, 9292 relationships, 176 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
