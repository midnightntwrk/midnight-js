...
class _CoinPreimage_0 {
  alignment() {
    return _descriptor_9.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_0.alignment())));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_9.toValue(value_0.domain_sep).concat(_descriptor_2.toValue(value_0.info).concat(_descriptor_3.toValue(value_0.dataType).concat(_descriptor_0.toValue(value_0.data))));
  }
}
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      receive_coin: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`receive_coin: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const coin_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('receive_coin',
                                     'argument 1 (as invoked from Typescript)',
                                     'coin-receiver.compact line 20 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = this._receive_coin_0(context, partialProofData, coin_0);
        partialProofData.output = { value: [], alignment: [] };
        return { result: result_0, context: context, proofData: partialProofData, gasCost: context.gasCost };
      }
    };
    this.impureCircuits = { receive_coin: this.circuits.receive_coin };
    this.provableCircuits = { receive_coin: this.circuits.receive_coin };
  }
  initialState(...args_0) {
    if (args_0.length !== 1) {
    ...
    state_0.setOperation('receive_coin', new __compactRuntime.ContractOperation());
  ...
  _receive_coin_0(context, partialProofData, coin_0) {
    ...
    __compactRuntime.hasCoinCommitment(context, coin_0, tmp_0) ? __compactRuntime.queryLedgerState(context,
                                                                                                   ...
                                                                                                   [
                                                                                                    ...
                                                                                                    { concat: { cached: true,
                                                                                                                n: 91 } },
                                                                                                    { ins: { cached: false,
                                                                                                             n: 1 } }]) : (() => { throw new __compactRuntime.CompactError(`coin-receiver.compact line 22 char 3: Coin commitment not found. Check the coin has been received (or call 'createZswapOutput')`); })();
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
