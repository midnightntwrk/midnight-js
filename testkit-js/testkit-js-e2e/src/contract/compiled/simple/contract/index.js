...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      noop: async (...args_1) => {
        if (args_1.length !== 1) {
          throw new __compactRuntime.CompactError(`noop: expected 1 argument (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('noop',
                                     'argument 1 (as invoked from Typescript)',
                                     'simple.compact line 5 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const result_0 = await this._noop_0(context, partialProofData);
    ...
    this.provableCircuits = { noop: this.circuits.noop };
  }
  async initialState(...args_0) {
    ...
    state_0.setOperation('noop', new __compactRuntime.ContractOperation());
  ...
  async _noop_0(context, partialProofData) {
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
...
export const expectedVk = {
  'noop': '62d768951a97c18af8cb385f8c0fe6488a4dbfbebce83ea08b21914a0ebe7789',
};
