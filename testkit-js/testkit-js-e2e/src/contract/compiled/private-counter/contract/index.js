...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.localIncrement) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named localIncrement');
    }
      ...
      increment: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('increment',
                                     ...
                                     'private-counter.compact line 33 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
  ...
  _localIncrement_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.callContext.currentQueryContext.state), context.callContext.currentPrivateState, context.callContext.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.localIncrement(witnessContext_0);
    context.callContext.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 65535n)) {
      __compactRuntime.typeError('localIncrement',
                                 'return value',
                                 'private-counter.compact line 31 char 1',
                                 'Uint<0..65536>',
                                 result_0)
    }
  ...
  async _increment_0(context, partialProofData) {
    const tmp_0 = this._localIncrement_0(context, partialProofData);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
...
const _dummyContract = new Contract({ localIncrement: (...args) => undefined });
export const pureCircuits = {};
export const contractReferenceLocations =
  { tag: 'publicLedgerArray', indices: { } };
export const expectedVk = {
  'increment': 'f226f0f3fae6e2e7f632d907b7803d87450225000645cc52e747775dc1b0459e',
};
